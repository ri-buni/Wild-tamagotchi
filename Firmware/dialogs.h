...
//
// Coverage (each category exists for BOTH pets):
//   idle / night / eat / play / clean / sleep / visit / evolve / meet
//   hungry / tired / dirty / bored          (need-driven complaints)
//   home / garden / meadow / pond           (arrival at a location)
//   feedGarden / playMeadow / cleanPond     (location-bonus actions)
//   sleepAway                                (napping away from home)
// =====================================================================
...
// Arrival lines per location
const char* rabbitHome[]   = { "Home again.",   "My books...",     "*settles in*" };
const char* rabbitGarden[] = { "The garden.",   "Carrots grow.",   "*smells soil*" };
const char* rabbitMeadow[] = { "Fresh air.",    "Open sky...",     "*breathes*" };
const char* rabbitPond[]   = { "Still water.",  "*watches fish*",  "Calm here." };

// Location-bonus action lines
const char* rabbitFeedGarden[] = { "Fresh carrot. Mm.", "Garden-grown...", "Crisp." };
const char* rabbitPlayMeadow[] = { "*happy hops*",      "Room to run.",    "This is nice." };
const char* rabbitCleanPond[]  = { "Cool water...",     "*washes ears*",   "Very fresh." };
const char* rabbitSleepAway[]  = { "*naps lightly*",    "Not my bed...",   "Short rest." };
...
const char* bunnyMeet[]   = { "FRIEND!! HI!!", "YAY!! TOGETHER!!", "LET'S RUN!!" };
...
// Arrival lines per location
const char* bunnyHome[]   = { "HOME SWEET HOME!!", "MY TOYS!!",     "BALLOONS!!" };
const char* bunnyGarden[] = { "CARROTS!!!",        "DIG DIG DIG!!", "VEGGIE LAND!!" };
const char* bunnyMeadow[] = { "SO MUCH GRASS!!",   "RUN RUN RUN!!", "WIDE OPEN!!" };
const char* bunnyPond[]   = { "SPLASH SPLASH!!",   "FISHIES!!",     "WATER!! WOW!!" };

// Location-bonus action lines
const char* bunnyFeedGarden[] = { "FRESH CARROTS!!", "SO CRUNCHY!!",    "BEST SNACK!!" };
const char* bunnyPlayMeadow[] = { "ZOOMIES!!!",      "CAN'T STOP!!",    "WHEEEEEE!!" };
const char* bunnyCleanPond[]  = { "BATH TIME!!",     "SPLASHY CLEAN!!", "SO FRESH!!" };
const char* bunnySleepAway[]  = { "NAP ANYWHERE!!",  "*power flop*",    "QUICK ZZZ!!" };
